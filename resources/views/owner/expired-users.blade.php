                      ...
                      <table class="table-auto w-full text-left whitespace-no-wrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form id="delete_{{$user->id}}" method="post" action="{{ route('expired-users.destroy', ['user' => $user->id ] )}}">
                              @csrf
                              <td class="px-4 py-3">
                                <a href="#" data-id="{{ $user->id }}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">完全に削除</a>                        
                              </td>
                            </form>
                          </tr>
                          @endforeach
